...
function listClick(value){
	...
	if(value == 1){
		...
		$("#crowdfunding_iframe").attr("src","content?id=1");
...
$("#listClick19").attr("class","");
	...
	if(value == 2){
		...
		$("#crowdfunding_iframe").attr("src","content?id=2");
...
$("#listClick19").attr("class","");
	...
	if(value == 3){
		...
		$("#crowdfunding_iframe").attr("src","identity_prove");
...
$("#listClick19").attr("class","");
	...
	if(value == 4){
		...
		$("#crowdfunding_iframe").attr("src","content?id=3");
...
$("#listClick19").attr("class","");
	...
	if(value == 5){
		...
		$("#crowdfunding_iframe").attr("src","apply_lingtou");
...
$("#listClick19").attr("class","");
	...
	if(value == 6){
		...
		$("#crowdfunding_iframe").attr("src","content?id=4");
...
$("#listClick19").attr("class","");
	...
	if(value == 7){
		...
		$("#crowdfunding_iframe").attr("src","content?id=5");
...
$("#listClick19").attr("class","");
	...
	if(value == 8){
		...
		$("#crowdfunding_iframe").attr("src","my_account");
...
$("#listClick19").attr("class","");
	...
	if(value == 9){
		...
		$("#crowdfunding_iframe").attr("src","investment_inquiry");
...
$("#listClick19").attr("class","");
	...
	if(value == 10){
		...
		$("#crowdfunding_iframe").attr("src","apply_refund");
...
$("#listClick19").attr("class","");
	...
	if(value == 14){
		...
		$("#crowdfunding_iframe").attr("src","messages");
...
$("#listClick19").attr("class","");
	...
	if(value == 15){
		...
		$("#crowdfunding_iframe").attr("src","inbox");
...
$("#listClick19").attr("class","");
	...
	if(value == 16){
		...
		$("#crowdfunding_iframe").attr("src","outbox");
